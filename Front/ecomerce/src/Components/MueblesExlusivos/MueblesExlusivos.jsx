        ...
        <div className='w-[90%] m-auto'>
            ...
            <div className='flex gap-5 justify-center flex-wrap'>
                <div className='w-[260px] h-[390px] text-center p-5 text-sm'>
                    <img src={LR} alt="Living Room" className='rounded-md w-full h-full shadow-md hover:shadow-gray-400' />
                    <p className='font-bold mt-3'>Sala de estar</p>
                </div>
                <div className='w-[260px] h-[390px] text-center p-5 text-sm'>
                    <img src={BR} alt="Bedroom" className='rounded-md w-full h-full shadow-md hover:shadow-gray-400' />
                    <p className='font-bold mt-3'>Dormitorio</p>
                </div>
                <div className='w-[260px] h-[390px] text-center p-5 text-sm'>
                    <img src={WS} alt="WorkSpace" className='rounded-md w-full h-full shadow-md hover:shadow-gray-400' />
                    <p className='font-bold mt-3'>Espacio de Trabajo</p>
                </div>
                <div className='w-[260px] h-[390px] text-center p-5 text-sm'>
                    <img src={KC} alt="Kitchen" className='rounded-md w-full h-full shadow-md hover:shadow-gray-400' />
